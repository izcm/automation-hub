  ...
  return (
    <>
      {batchSelected.length > 0 && (
        <div className="flex items-center gap-2 raised-outline bg-raised-gradient px-4 py-3">
      ...
      <Gallery
        ...
        selected={selected}
        onSelect={onSelect}
        htmlUlElementProps={{ className: "flex flex-col gap-2 p-1" }}
        htmlLiElementProps={({ isSelected }) => ({
          className: cn("rounded", className?.(isSelected)),
        })}
        galleryItem={(item) => {
